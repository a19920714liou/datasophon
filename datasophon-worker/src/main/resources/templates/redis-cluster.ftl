...
COMMAND_CREATE_CLUSTER="echo yes | /opt/datasophon/redis_cluster/redis-cli --cluster create "
COMMAND_ADD_NODE="/opt/datasophon/redis_cluster/redis-cli --cluster add-node "

CONTROL_SCRIPT="/opt/datasophon/redis_cluster/control_redis.sh"
